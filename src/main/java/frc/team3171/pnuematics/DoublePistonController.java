...
public class DoublePistonController {
     ...
     *            The {@linkplain DoubleSolenoid} used for extending and
     ...
     * @param moduleType
     *            The type of pneumatic control module being used, either
     *            CTRE or REV.
     * @param forwardChannel
     *            The forward channel on the module to control (0-7).
     ...
     * 
     * @param duration
     *            The Duration that the {@linkplain DoublePistonController}
